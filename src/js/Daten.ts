...
class Daten {
    ...
    loadER(zoomToExtentWhenReady?: boolean) {
        if (zoomToExtentWhenReady != undefined && zoomToExtentWhenReady == true)
            ...
            this.warteAufObjektklassen = 999;
        Querschnitt.loadER(this.loadErCallback.bind(this));
        Aufstellvorrichtung.loadER(this.loadErCallback.bind(this));
        StrassenAusPunkt.loadER(this.loadErCallback.bind(this));
    }
